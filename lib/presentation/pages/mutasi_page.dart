...
class _MutasiPageState extends State<MutasiPage> {
  ...
  String _selectedRange = 'Semua'; // Default selection for time range
  ...
  void filterTransactions() {
    setState(() {
      ...
      if (_selectedRange == 'Hari ini') {
        ...
        // Default: Show all transactions if no filter is applied
        filteredTransactions = List.from(transactions);
      }
      print("Filtered transactions: $filteredTransactions"); // Debugging output
    });
  }
                ...
                RadioListTile(
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      filterTransactions(); // Show all transactions
                    });
                  },
                ),
                RadioListTile(
